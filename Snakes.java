...
class Ladder extends JFrame {
	...
	{   
		...
		l1.setIcon(i5);     //Mengatur kembali ikon gambar label.
		repaint();

		///adding title
		panel=new JPanel();
		panel.setLayout(null);
		panel.setBounds(0, 0, 800,100 );    //untuk menentukan posisi panel di dalam frame beserta width dan height.
		...
		ImageIcon i=new ImageIcon(getClass().getResource("hkittyy.gif"));
		...
		i13=new ImageIcon(getClass().getResource("sanrioo.gif"));
		l6=new JLabel();
		l6.setBounds(510,300,270,270);
		l6.setIcon(i13);
		i14=new ImageIcon(getClass().getResource("ket.png"));
		l7=new JLabel();
		...
		a1=new JTextArea("Player 1 merah dan Player 2 biru.\nPermainan dimulai dari player 1.");
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			if(l5.getY()==196)
			{
				...
				JOptionPane.showMessageDialog(null,"Giliran Player 2");
			}
			...
			else
			{
				...
				if(x1>100)
				{
					...
					a1.setText("Kamu melewati angka 100 !!\nTunggu giliran selanjutnya");
				...
				else
				{
					if(c1==6)
					{
						...
						l5.setLocation(550,136);
						t3.setText(Integer.toString(x1));
						a1.setText("Kamu mendapat angka 6 !! Main lagi");
					}
					else
					{
						count1=0;
						...
						case 71:
							x1=91;
							a1.setText("kamu naika");break;
						case 80:
							x1=100;
							a1.setText("kamu naik");break;
						case 17:
							x1=7;
							a1.setText("kamu turun");break;
						case 62:
							x1=19;
							a1.setText("kamu turun");break;
						case 64:
						...
						if(x1<100)
						{
							...
							if(t3.getText().equals(t4.getText()))
							{
								...
								b4.setLocation(50,500);
								panel2.add(b4);
								a1.setText("Merah ambil alih !! Biru mulai lagi");
								repaint();
							}
							int a1,b1,d1;
							d1=x1/10;
						...
						{
							t3.setText(Integer.toString(x1));
							a1.setText("Player 1 menang");
							int c=JOptionPane.showConfirmDialog(null,"Player 1 menang\n\nMain lagi?");
							if(c==0)
							{
...

		{
			...
			if(l5.getY()==136)
			{
				JOptionPane.showMessageDialog(null,"Giliran player 1");
			}
			else
			{
					...
					else
					{
						...
						if(x2<100)
						{
							...
							if(t4.getText().equals(t3.getText()))
							{
								...
								b3.setLocation(0,500);
								panel2.add(b3);
								a1.setText("Biru ambil alih !! Merah mulai lagi");
								repaint();
							}
							int a2,b2,d2;
							d2=x2/10;
						...
						else
						{
							...
							a1.setText("Player 2 menang");
							int c=JOptionPane.showConfirmDialog(null,"Player 2 menang\n\nMain lagi?");
							if(c==0)
							{
								AudioPlayer.player.stop(winas);
								AudioPlayer.player.start(as);
	...
	void playagain()
	{
		...
		panel2.add(b3);
		panel2.add(b4);
		a1.setText("Mulai permainan dengan klik player 1");
		repaint();
	}
}
